...
const HeroRelatorios = () => {
    const heroData = relatoriosContasPageContent[0]?.content[0]?.heroContent[0];
                ...
                <div className="w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-center items-end sm:items-center gap-8 p-4">
                    ...
                    <div className="w-1/2 flex justify-end lg:justify-start relative">
                        <Image
                            ...
                            src={heroData.logo}
                            className="absolute bottom-0 lg:-bottom-36 w-auto max-w-16 h-auto max-h-16"
                        />
                    </div>
                </div>
            </div>
