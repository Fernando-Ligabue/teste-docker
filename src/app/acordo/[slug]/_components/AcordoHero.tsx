...
interface HeroAcordoProps {
    slug: string;
}

const HeroAcordo: React.FC<HeroAcordoProps> = ({ slug }) => {
    const contentPageData = acordosPageContent[0].contentPages[slug];
