...
const SectionOrgaosSociais = () => {
    const cpme = orgaosSociaisPageContent?.[0]?.sectionCPME?.[0];
  ...
  return (
    ...
    <div className="max-w-screen-xl flex flex-col lg:flex-row justify-between items-center md:gap-14 mx-auto p-4">
        ...
        <div className='w-full sm:w-1/2 md:p-8 rounded-sm'>
            <Image
                width={650}
                height={650}
...
export default SectionOrgaosSociais