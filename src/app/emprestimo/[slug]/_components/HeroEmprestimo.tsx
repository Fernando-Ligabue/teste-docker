...
interface HeroEmprestimoProps {
    slug: string;
}

const HeroEmprestimo: React.FC<HeroEmprestimoProps> = ({ slug }) => {
    const contentPageData = emprestimosPageContent[0].contentPages[slug];
    const heroContent = emprestimosPageContent[0].content[0].heroContent[0];
    ...
    return (
        <section className="min-h-dvh w-full flex flex-col justify-end lg:justify-center items-center relative">
            ...
            <div className="w-full lg:max-w-screen-xl max-w-container flex justify-between items-center mt-24 pb-8 relative">
                <div className="relative w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between items-end sm:items-center gap-8 p-4">
                    <div className="w-full max-w-full lg:w-1/2">
                        <BlockHeader1
                            ...
                            complementText={contentPageData.descriptionText}
                            headingSize="text-3xl sm:text-4xl"
                        />
                    </div>
                    <div className="w-full lg:w-1/2 flex justify-end lg:absolute bottom-36 lg:-bottom-64 right-4">
                        <img
                            width={400}
                            height={400}
