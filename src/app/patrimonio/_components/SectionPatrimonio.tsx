...
const SectionPatrimonio = () => {
    const cpme = patrimonioPageContent?.[0]?.sectionCPME?.[0];

    return (
        <section className="relative overflow-hidden w-full max-w-container py-20 lg:py-28 lg:pb-60">
...
export default SectionPatrimonio