...
const HeroArrendamento = () => {
    const arrendamentoData = arrendamentoPageContent[0]?.content[0]?.heroContent[0];
    ...
    return (
        <section className="min-h-dvh w-full flex flex-col justify-end lg:justify-center items-center relative">
            ...
            <div className="absolute top-0 left-0 w-full h-full z-0">
                <Image
                    src={arrendamentoData.background}
                    alt="Banner"
                    fill
            ...
            <div className="w-full lg:w-2/3 max-w-container flex justify-between items-center mt-24 pb-8 relative">
                <div className="relative w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between items-end sm:items-center gap-8 p-4">
                    <div className="w-full lg:w-1/2">
                        <BlockHeader1
                            label={arrendamentoData.label}
                            heading={arrendamentoData.heading}
                            complementText={arrendamentoData.descriptionText}
                            headingSize="text-2xl sm:text-4xl"
                        />
                    </div>
                    <div className="w-full lg:w-1/2 flex justify-end lg:absolute bottom-28 lg:-bottom-60 right-4">
                        <img
                            width={400}
                            height={400}
                            alt="CPME - Caixa de Previdência do Ministério da Educação"
                            src={arrendamentoData.logo}
...
export default HeroArrendamento;
